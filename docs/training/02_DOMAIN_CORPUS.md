...
Curriculum stage **2 of 3** before SFT. Previous: [01_UNIFIED_FROM_SCRATCH.md](01_UNIFIED_FROM_SCRATCH.md). Then train on the corpus: [02_DOMAIN_ADAPTATION.md](02_DOMAIN_ADAPTATION.md). Map: [README.md](README.md).
...
- `scripts/README.md` — tokenization pipeline
- Domain datagrabber specification (not published)
- `data/sources/multilingual_de_en.json` — example source config (local data, not in this tree)
