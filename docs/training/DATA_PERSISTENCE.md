...
- [Tokenization Comparison](../model/TOKENIZATION_COMPARISON.md) - GPT-2 vs char
- Chat SFT with context: see [docs/sft/phases/PHASE3_CHAT.md](../sft/phases/PHASE3_CHAT.md)
