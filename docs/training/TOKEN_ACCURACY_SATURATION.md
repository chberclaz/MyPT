...
- Training/eval loop and detector logic: [`core/model.py`](../../core/model.py)
- Config plumbing from JSON config into fit loop: [`train.py`](../../train.py)
- Example config usage: [`configs/sft/phase3_1_corrective.json`](../../configs/sft/phase3_1_corrective.json)
