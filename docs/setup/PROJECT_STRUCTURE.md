...
- Active references live under:
  - `docs/setup/`
  - `docs/guides/`
  - `docs/training/` — numbered pretrain stages 01–03, then mechanics; map in `docs/training/README.md`
  - `docs/sft/` — CURRENT_STATE, pipeline, autopilot; phase stubs in `docs/sft/phases/`; mix-role audits in `docs/sft/validation/`
  - `docs/model/`
  - `docs/webapp/`
  - `docs/compliance/`
  - `docs/reference/`
