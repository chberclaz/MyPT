...
def build_return_only_examples(rng: random.Random, n: int) -> List[Dict]:
    ...
    for _ in range(n):
        ...
        out.append(_episode(CHAT_SYSTEM_PROMPT, user, x))
    return out
...
def build_classify_examples(rng: random.Random, n: int) -> List[Dict]:
    ...
    for _ in range(n):
        ...
        out.append(_episode(CHAT_SYSTEM_PROMPT, user, label))
    return out
...
def build_format_examples(rng: random.Random, n: int) -> List[Dict]:
    ...
    for _ in range(n):
        ...
        out.append(_episode(CHAT_SYSTEM_PROMPT, user, js))
    return out
...
def build_toolfree_discipline_examples(rng: random.Random, n: int) -> List[Dict]:
    ...
    for _ in range(n):
        ...
        out.append(_episode(CHAT_SYSTEM_PROMPT, _decorate_instruction(q, rng), a))
    return out
